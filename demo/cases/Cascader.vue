<template>
    <article>
        ...
        <h2>尺寸</h2>
        <div class="options-desc">可选的尺寸 <span class="bg-gray-show">ui</span> 属性值： <span class="bg-gray-show">xs / s / m / l</span></div>
        <section>
            <veui-form>
                <veui-field label="超小号[ui=xs]" ui="multi" class="tow-line-field">
                    <cascader
                        v-model="value2"
                        :options="options"
...
<script>
import {Cascader, Checkbox, Radio, NumberInput, Input, Form, Field} from 'veui';
