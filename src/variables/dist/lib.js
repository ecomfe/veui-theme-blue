...
function install$2(less, pluginManager, functions) {
...
function install$3(less, pluginManager, functions) {
...
function install$4(less, pluginManager, functions) {
...
function install$5(less, pluginManager, functions) {
...
function install$6(...args) {
    [install$2, install$3, install$4, install$5].forEach(install =>
